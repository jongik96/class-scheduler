export const en = {
  ...
  common: {
    ...
    redirectingToSchedule: 'Redirecting to schedule...',
    redirectingToAssignmentList: 'Redirecting to assignment list...',
    creating: 'Creating...',
    updating: 'Updating...',
    deleting: 'Deleting...',
    ...
    info: 'Information',
    debug: 'Debug',
    courseDataLoadError: 'Failed to load course data',
    assignmentDataLoadError: 'Failed to load assignment data',
    courseUpdateError: 'Failed to update course',
    assignmentUpdateError: 'Failed to update assignment',
    courseDeleteError: 'Failed to delete course',
    assignmentDeleteError: 'Failed to delete assignment',
    invalidTimeRange: 'End time must be after start time',
    timeRangeDescription: '9 AM - 8 PM, 30-minute intervals',
    endTimeDescription: 'Set after start time',
    preview: 'Preview',
    coursePreview: 'Course Preview',
    assignmentPreview: 'Assignment Preview',
    editCourseTitle: 'Edit Course',
    editCourseSubtitle: 'Edit existing course information',
    editAssignmentTitle: 'Edit Assignment',
    editAssignmentSubtitle: 'Edit existing assignment information',
    ...
    descriptionPlaceholder: 'Enter additional course description',
    ...
    timeValidationError: 'Invalid time settings',
    formValidationError: 'Please check your input',
  ...
  friends: {
    ...
    qrCode: 'QR Code',
    qrCodeDescription: 'Scan this QR code to invite friends',
    qrCodePlaceholder: 'QR code will be displayed here after generating invite link',
